...
fileName = "simulation\simSet3.tsv"
...
for season in ['winter', 'summer']:
    for day in ([11, 20, 3] if season == 'winter' else [7, 10, 2]):
        for capacitance in [476, 352, 205]:
            for sampleNum in [10, 20, 30]:
                for sampleSize in [10, 20, 30]:
                    for sleep in [5, 10, 20]:
                        ...
                        columns[header[6]] += [2.7]
                        columns[header[7]] += [2.2]
