...
fileName = "simulation\simSet10.tsv"
...
for season in ['summer']:
    for day in ([11, 3] if season == 'winter' else [2]): # winter[11,20,3], summer[7, 10, 2]
        for capacitance in [147]:
            for sampleNum, sampleSize, sleep in [[10,10,5]]:
