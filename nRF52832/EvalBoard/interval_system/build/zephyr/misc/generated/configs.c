...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_LPCOMP_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_LPCOMP, 1);
